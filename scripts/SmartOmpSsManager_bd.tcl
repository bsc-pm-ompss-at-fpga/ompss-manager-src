...
proc create_root_design { parentCell } {
  ...
  # Create instance: Spawn_Out, and set properties
  set Spawn_Out [ create_bd_cell -type ip -vlnv bsc:ompss:Spawn_Out_wrapper Spawn_Out ]
  ...
  connect_bd_intf_net -intf_net New_Task_Manager_newQueue_PORTA [get_bd_intf_ports spawnOutQueue] [get_bd_intf_pins Spawn_Out/SpawnOutQueue_PORTA]
  ...
  connect_bd_intf_net -intf_net Spawn_Out_outStream [get_bd_intf_pins Spawn_Out/outStream] [get_bd_intf_pins outStream_Inter_Taskwait_Task_Manager/S02_AXIS]
  connect_bd_intf_net -intf_net Taskwait_twInfo_PORTA [get_bd_intf_ports twInfo] [get_bd_intf_pins Taskwait/twInfo_PORTA]
  connect_bd_intf_net -intf_net ext_inStream_Inter_M00_AXIS [get_bd_intf_pins Spawn_Out/inStream] [get_bd_intf_pins ext_inStream_Inter/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net ext_inStream_Inter_M02_AXIS [get_bd_intf_pins Scheduler/inStream] [get_bd_intf_pins ext_inStream_Inter/M02_AXIS]
