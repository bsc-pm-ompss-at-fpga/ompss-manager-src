...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net Lock_outStream [get_bd_intf_pins Lock/outStream] [get_bd_intf_pins outStream_Inter_Taskwait_Task_Manager/S02_AXIS]
