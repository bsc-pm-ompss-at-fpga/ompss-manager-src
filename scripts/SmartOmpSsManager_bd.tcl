...
proc create_root_design { parentCell max_accs } {
   ...
   connect_bd_intf_net -intf_net Lock_outStream [get_bd_intf_pins Lock/outStream] [get_bd_intf_pins $twOutStream_Inter/S02_AXIS]
