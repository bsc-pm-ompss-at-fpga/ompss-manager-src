...
exec sed -i s/${name_IP}\ ${name_IP}_i/parameter\ lock_support=0\;\\n\\n\ \ ${name_IP}\\n\ \ \ \ \ \ #(.lock_support(lock_support))\\n\ \ ${name_IP}_i/g $hdl_file
...
set_property tooltip "Enable POM lock support feature" [ipgui::get_guiparamspec -name $name_param -component [ipx::current_core] ]
