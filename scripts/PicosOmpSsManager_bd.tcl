...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_AND_Res [get_bd_ports managed_aresetn] [get_bd_pins Command_In/ap_rst_n] [get_bd_pins Command_Out/ap_rst_n] [get_bd_pins Cutoff/aresetn] [get_bd_pins Picos/aresetn] [get_bd_pins Scheduler/ap_rst_n] [get_bd_pins Spawn_In/ap_rst_n] [get_bd_pins Taskwait/ap_rst_n] [get_bd_pins rst_AND/Res]
