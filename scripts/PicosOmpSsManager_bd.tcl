...
# source PicosOmpSsManager_script.tcl
...
set design_name PicosOmpSsManager
...
if { $bCheckIPs == 1 } {
   ...
   set list_rtl_missing ""
   common::send_msg_id "BD_TCL-006" "INFO" "Checking if the following rtl sources exist in the project files: $list_check_rtl ."

   foreach rtl_src $list_check_rtl {
      set rtl_obj [get_files $rtl_src]
      if { $rtl_obj eq "" } {
         lappend list_rtl_missing $rtl_src
      }
   }

   if { $list_rtl_missing ne "" } {
      catch {common::send_msg_id "BD_TCL-115" "ERROR" "The following rtl sources are not found in the project files:\n $list_rtl_missing\n\nResolution: Please add the sources to the project." }
      set bCheckIPsPassed 0
   }
...
proc create_inStream_Inter_tree { stream_name masters max_accs } {
...
proc create_outStream_Inter_tree { stream_name slaves max_accs } {
   set n_inter [expr int(ceil($max_accs/16.))]
   set prev_n_inter $max_accs
   set inter_level 0
   set stride 1
...
proc create_root_design { parentCell max_accs } {
   ...
   # Create instance: Picos_finish_task_Inter, and set properties
   set Picos_finish_task_Inter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect Picos_finish_task_Inter ]
   set_property -dict [ list \
      CONFIG.ARB_ON_MAX_XFERS {1} \
      CONFIG.ARB_ON_TLAST {0} \
      CONFIG.NUM_MI {1} \
   ...
   # Create instance: Sched_inStream_Inter, and set properties
   set Sched_inStream_Inter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect Sched_inStream_Inter ]
   set_property -dict [ list \
      CONFIG.ARB_ON_MAX_XFERS {0} \
      CONFIG.ARB_ON_TLAST {1} \
      CONFIG.NUM_MI {1} \
   ...
   set max_level [expr [create_inStream_Inter_tree inStream_Inter 4 $max_accs] - 1]
   if {$max_level == 0} {
      create_outStream_Inter_tree outStream_Inter 5 $max_accs
   } else {
      create_outStream_Inter_tree outStream_Inter 2 $max_accs
   }
   ...
   if {$max_level == 0} {
      ...
      set outStream_Inter_S0 outStream_Inter_lvl0_0/S00_AXIS
      set outStream_Inter_S1 outStream_Inter_lvl0_0/S01_AXIS
      set outStream_Inter_S2 outStream_Inter_lvl0_0/S02_AXIS
      set outStream_Inter_S3 outStream_Inter_lvl0_0/S03_AXIS
      set outStream_Inter_S4 outStream_Inter_lvl0_0/S04_AXIS
   } else {
      ...
      set last_inter_s1 outStream_Inter_lvl${max_level}_s1_0
      set_property -dict [ list CONFIG.NUM_SI {4} ] [ get_bd_cell $last_inter_s1 ]
      connect_bd_net [get_bd_ports peripheral_aresetn] [get_bd_pins $last_inter_s1/S01_AXIS_ARESETN] [get_bd_pins $last_inter_s1/S02_AXIS_ARESETN] [get_bd_pins $last_inter_s1/S03_AXIS_ARESETN]
      connect_bd_net [get_bd_ports aclk] [get_bd_pins $last_inter_s1/S01_AXIS_ACLK] [get_bd_pins $last_inter_s1/S02_AXIS_ACLK] [get_bd_pins $last_inter_s1/S03_AXIS_ACLK]
      set outStream_Inter_S0 outStream_Inter_lvl${max_level}_s0_0/S00_AXIS
      set outStream_Inter_S1 outStream_Inter_lvl${max_level}_s1_0/S00_AXIS
      set outStream_Inter_S2 outStream_Inter_lvl${max_level}_s1_0/S01_AXIS
      set outStream_Inter_S3 outStream_Inter_lvl${max_level}_s1_0/S02_AXIS
      set outStream_Inter_S4 outStream_Inter_lvl${max_level}_s1_0/S03_AXIS
   }
   ...
   connect_bd_intf_net -intf_net Command_In_outStream [get_bd_intf_pins Command_In/outStream] [get_bd_intf_pins $outStream_Inter_S0]
   ...
   connect_bd_intf_net -intf_net Command_out_Picos_finish_task [get_bd_intf_pins Command_Out/picosFinishTask] [get_bd_intf_pins Picos_finish_task_Inter/S01_AXIS]
   ...
   connect_bd_intf_net -intf_net Picos_finish_task [get_bd_intf_pins Picos/finish_task] [get_bd_intf_pins Picos_finish_task_Inter/M00_AXIS]
   connect_bd_intf_net -intf_net Picos_ready_task [get_bd_intf_pins Picos/ready_task] [get_bd_intf_pins Sched_inStream_Inter/S01_AXIS]
   ...
   connect_bd_intf_net -intf_net Scheduler_inStream [get_bd_intf_pins Sched_inStream_Inter/M00_AXIS] [get_bd_intf_pins Scheduler/inStream]
   ...
   connect_bd_intf_net -intf_net Scheduler_outStream [get_bd_intf_pins Scheduler/outStream] [get_bd_intf_pins $outStream_Inter_S2]
   ...
   connect_bd_intf_net -intf_net Spawn_in_Picos_finish_task [get_bd_intf_pins Picos_finish_task_Inter/S00_AXIS] [get_bd_intf_pins Spawn_In/picosFinishTask]
   connect_bd_intf_net -intf_net Taskwait_outStream [get_bd_intf_pins Taskwait/outStream] [get_bd_intf_pins $outStream_Inter_S1]
   connect_bd_intf_net -intf_net Taskwait_twInfo [get_bd_intf_pins Taskwait/twInfo] [get_bd_intf_pins tw_info/portA]
   connect_bd_intf_net -intf_net cutoff_ack [get_bd_intf_pins Cutoff/ack] [get_bd_intf_pins $outStream_Inter_S3]
   connect_bd_intf_net -intf_net Lock_outStream [get_bd_intf_pins Lock/outStream] [get_bd_intf_pins $outStream_Inter_S4]
   ...
   connect_bd_intf_net -intf_net inStream_Inter_M01_AXIS [get_bd_intf_pins Cutoff/inStream] [get_bd_intf_pins $inStream_Inter_M1]

   # Create port connections
   connect_bd_net -net aclk_1 [get_bd_ports aclk] [ get_bd_pins Picos_finish_Task_Inter/ACLK ] [ get_bd_pins Picos_finish_Task_Inter/S00_AXIS_ACLK ] [ get_bd_pins Picos_finish_Task_Inter/S01_AXIS_ACLK ] [ get_bd_pins Picos_finish_Task_Inter/M00_AXIS_ACLK ] [ get_bd_pins Sched_inStream_Inter/ACLK ] [ get_bd_pins Sched_inStream_Inter/S00_AXIS_ACLK ] [ get_bd_pins Sched_inStream_Inter/S01_AXIS_ACLK ] [ get_bd_pins Sched_inStream_Inter/M00_AXIS_ACLK ] [ get_bd_pins Picos/clk ] [ get_bd_pins Cutoff/clk ] [get_bd_pins Command_In/clk] [get_bd_pins Command_Out/clk] [get_bd_pins Scheduler/clk] [get_bd_pins Spawn_In/clk] [get_bd_pins Taskwait/clk] [get_bd_pins Taskwait_inStream_Inter/ACLK] [get_bd_pins Taskwait_inStream_Inter/M00_AXIS_ACLK] [get_bd_pins Lock/clk] [get_bd_pins Taskwait_inStream_Inter/S00_AXIS_ACLK] [get_bd_pins Taskwait_inStream_Inter/S01_AXIS_ACLK] [get_bd_pins Taskwait_inStream_Inter/S02_AXIS_ACLK]
   connect_bd_net -net interconnect_aresetn_1 [get_bd_ports interconnect_aresetn] [ get_bd_pins Picos_finish_Task_Inter/ARESETN ] [ get_bd_pins Sched_inStream_Inter/ARESETN ] [get_bd_pins Taskwait_inStream_Inter/ARESETN]
   connect_bd_net -net peripheral_aresetn_1 [get_bd_ports peripheral_aresetn] [ get_bd_pins Picos_finish_Task_Inter/S00_AXIS_ARESETN ] [ get_bd_pins Picos_finish_Task_Inter/S01_AXIS_ARESETN ] [ get_bd_pins Picos_finish_Task_Inter/M00_AXIS_ARESETN ] [ get_bd_pins Sched_inStream_Inter/S00_AXIS_ARESETN ] [ get_bd_pins Sched_inStream_Inter/S01_AXIS_ARESETN ] [get_bd_pins Sched_inStream_Inter/M00_AXIS_ARESETN] [get_bd_pins Taskwait_inStream_Inter/M00_AXIS_ARESETN] [get_bd_pins Taskwait_inStream_Inter/S00_AXIS_ARESETN] [get_bd_pins Taskwait_inStream_Inter/S01_AXIS_ARESETN] [get_bd_pins Taskwait_inStream_Inter/S02_AXIS_ARESETN] [get_bd_pins rst_AND/Op1]
   connect_bd_net -net Picos_picos_full [get_bd_pins Cutoff/picos_full] [get_bd_pins Picos/picos_full]
   connect_bd_net -net Scheduler_picosRejectTask_id [get_bd_pins Picos/retry_id] [get_bd_pins Scheduler/picosRejectTask_id]
   connect_bd_net -net Scheduler_picosRejectTask_valid [get_bd_pins Picos/retry_valid] [get_bd_pins Scheduler/picosRejectTask_valid]
   connect_bd_net -net ps_rst_1 [get_bd_ports ps_rst] [get_bd_pins rst_NOT/Op1]
   connect_bd_net -net rst_AND_Res [get_bd_ports managed_aresetn] [get_bd_pins Command_In/rstn] [get_bd_pins Command_Out/rstn] [get_bd_pins Cutoff/rstn] [get_bd_pins Picos/rstn] [get_bd_pins Scheduler/rstn] [get_bd_pins Spawn_In/rstn] [get_bd_pins Taskwait/rstn] [get_bd_pins rst_AND/Res] [get_bd_pins Lock/rstn]
