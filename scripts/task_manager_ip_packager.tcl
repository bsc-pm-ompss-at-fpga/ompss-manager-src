...
if {[catch {source -notrace $root_dir/scripts/task_manager_bd.tcl}]} {
...
ipx::archive_core $prj_dir/IP_packager/${name_IP}_${num_version}_${vivado_version}_IP/bsc_ompss_[string tolower $name_IP]_${num_version}.zip [ipx::current_core]
