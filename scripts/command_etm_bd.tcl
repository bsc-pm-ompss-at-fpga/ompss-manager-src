...
################################################################
# This is a generated script based on design: Command_ETM
#
...
proc create_root_design { parentCell } {
  ...
  set accAvailability_CITM [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 accAvailability_CITM ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
 ] $accAvailability_CITM
  set accAvailability_COTM [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 accAvailability_COTM ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set inQueue [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 inQueue ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
 ] $inQueue
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set intCmdInQueue_CITM [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 intCmdInQueue_CITM ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
 ] $intCmdInQueue_CITM
...
CONFIG.MASTER_TYPE {BRAM_CTRL} \
  ...
  set newQueue [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 newQueue ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
 ] $newQueue
  ...
  set twInfo [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 twInfo ]
  set_property -dict [ list \
CONFIG.MASTER_TYPE {BRAM_CTRL} \
 ] $twInfo
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_RESET {interconnect_aresetn:peripheral_aresetn:ps_rst_n} \
 ] $aclk
  ...
  # Create instance: Cmd_Out_Task_Manager, and set properties
  set Cmd_Out_Task_Manager [ create_bd_cell -type ip -vlnv bsc:ompss:Cmd_Out_Task_Manager_wrapper Cmd_Out_Task_Manager ]

  # Create instance: New_Task_Manager, and set properties
  set New_Task_Manager [ create_bd_cell -type ip -vlnv bsc:ompss:New_Task_Manager_wrapper New_Task_Manager ]

  # Create instance: Remote_Finished_Task_Manager, and set properties
  set Remote_Finished_Task_Manager [ create_bd_cell -type ip -vlnv bsc:ompss:Remote_Finished_Task_Manager_wrapper Remote_Finished_Task_Manager ]

  # Create instance: Scheduler_Task_Manager, and set properties
  set Scheduler_Task_Manager [ create_bd_cell -type ip -vlnv bsc:ompss:Scheduler_Task_Manager_wrapper Scheduler_Task_Manager ]

  # Create instance: Taskwait_Task_Manager, and set properties
  set Taskwait_Task_Manager [ create_bd_cell -type ip -vlnv bsc:ompss:Taskwait_Task_Manager_wrapper Taskwait_Task_Manager ]
...
CONFIG.M00_AXIS_HIGHTDEST {0x00000012} \
CONFIG.M01_AXIS_BASETDEST {0x00000013} \
...
CONFIG.NUM_SI {16} \
  ...
  # Create instance: inStream_Taskwait_Inter, and set properties
  set inStream_Taskwait_Inter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect inStream_Taskwait_Inter ]
  set_property -dict [ list \
CONFIG.ARB_ON_MAX_XFERS {0} \
CONFIG.ARB_ON_TLAST {1} \
CONFIG.M00_AXIS_BASETDEST {0x00000013} \
CONFIG.M00_AXIS_HIGHTDEST {0x00000013} \
CONFIG.NUM_MI {1} \
CONFIG.NUM_SI {3} \
 ] $inStream_Taskwait_Inter
...
CONFIG.C_SIZE {1} \
  ...
  # Create instance: twOutStream_Inter, and set properties
  set twOutStream_Inter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect twOutStream_Inter ]
  set_property -dict [ list \
CONFIG.ARB_ON_MAX_XFERS {0} \
CONFIG.ARB_ON_TLAST {0} \
CONFIG.M00_AXIS_BASETDEST {0x00000011} \
...
CONFIG.NUM_SI {1} \
  ...
  connect_bd_intf_net -intf_net Cmd_In_Task_Manager_cmdInQueue_PORTA [get_bd_intf_ports cmdInQueue] [get_bd_intf_pins Cmd_In_Task_Manager/cmdInQueue_PORTA]
  connect_bd_intf_net -intf_net Cmd_In_Task_Manager_intCmdInQueue_PORTA [get_bd_intf_ports intCmdInQueue_CITM] [get_bd_intf_pins Cmd_In_Task_Manager/intCmdInQueue_PORTA]
  connect_bd_intf_net -intf_net Cmd_In_Task_Manager_outStream [get_bd_intf_pins Cmd_In_Task_Manager/outStream] [get_bd_intf_pins outStream_Inter/S00_AXIS]
  connect_bd_intf_net -intf_net Cmd_Out_Task_Manager_accAvailability_PORTA [get_bd_intf_ports accAvailability_COTM] [get_bd_intf_pins Cmd_Out_Task_Manager/accAvailability_PORTA]
  connect_bd_intf_net -intf_net Cmd_Out_Task_Manager_cmdOutQueue_PORTA [get_bd_intf_ports cmdOutQueue] [get_bd_intf_pins Cmd_Out_Task_Manager/cmdOutQueue_PORTA]
  connect_bd_intf_net -intf_net Cmd_Out_Task_Manager_outStream [get_bd_intf_pins Cmd_Out_Task_Manager/outStream] [get_bd_intf_pins inStream_Taskwait_Inter/S01_AXIS]
  connect_bd_intf_net -intf_net New_Task_Manager_newQueue_PORTA [get_bd_intf_ports newQueue] [get_bd_intf_pins New_Task_Manager/newQueue_PORTA]
  connect_bd_intf_net -intf_net Remote_Finished_Task_Manager_inQueue_PORTA [get_bd_intf_ports inQueue] [get_bd_intf_pins Remote_Finished_Task_Manager/inQueue_PORTA]
  connect_bd_intf_net -intf_net Remote_Finished_Task_Manager_outStream [get_bd_intf_pins Remote_Finished_Task_Manager/outStream] [get_bd_intf_pins inStream_Taskwait_Inter/S02_AXIS]
  ...
  connect_bd_intf_net -intf_net ext_inStream_Inter_M00_AXIS [get_bd_intf_pins New_Task_Manager/inStream] [get_bd_intf_pins ext_inStream_Inter/M00_AXIS]
  connect_bd_intf_net -intf_net ext_inStream_Inter_M01_AXIS [get_bd_intf_pins ext_inStream_Inter/M01_AXIS] [get_bd_intf_pins inStream_Taskwait_Inter/S00_AXIS]
  connect_bd_intf_net -intf_net ext_inStream_Inter_M02_AXIS [get_bd_intf_pins Scheduler_Task_Manager/inStream] [get_bd_intf_pins ext_inStream_Inter/M02_AXIS]
  connect_bd_intf_net -intf_net inStream_Inter_M00_AXIS [get_bd_intf_pins Cmd_Out_Task_Manager/inStream] [get_bd_intf_pins inStream_Inter/M00_AXIS]
  connect_bd_intf_net -intf_net inStream_Taskwait_Inter_M00_AXIS [get_bd_intf_pins Taskwait_Task_Manager/inStream] [get_bd_intf_pins inStream_Taskwait_Inter/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net twOutStream_Inter_M00_AXIS [get_bd_intf_ports twOutStream_0] [get_bd_intf_pins twOutStream_Inter/M00_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M01_AXIS [get_bd_intf_ports twOutStream_1] [get_bd_intf_pins twOutStream_Inter/M01_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M02_AXIS [get_bd_intf_ports twOutStream_2] [get_bd_intf_pins twOutStream_Inter/M02_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M03_AXIS [get_bd_intf_ports twOutStream_3] [get_bd_intf_pins twOutStream_Inter/M03_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M04_AXIS [get_bd_intf_ports twOutStream_4] [get_bd_intf_pins twOutStream_Inter/M04_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M05_AXIS [get_bd_intf_ports twOutStream_5] [get_bd_intf_pins twOutStream_Inter/M05_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M06_AXIS [get_bd_intf_ports twOutStream_6] [get_bd_intf_pins twOutStream_Inter/M06_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M07_AXIS [get_bd_intf_ports twOutStream_7] [get_bd_intf_pins twOutStream_Inter/M07_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M08_AXIS [get_bd_intf_ports twOutStream_8] [get_bd_intf_pins twOutStream_Inter/M08_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M09_AXIS [get_bd_intf_ports twOutStream_9] [get_bd_intf_pins twOutStream_Inter/M09_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M10_AXIS [get_bd_intf_ports twOutStream_10] [get_bd_intf_pins twOutStream_Inter/M10_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M11_AXIS [get_bd_intf_ports twOutStream_11] [get_bd_intf_pins twOutStream_Inter/M11_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M12_AXIS [get_bd_intf_ports twOutStream_12] [get_bd_intf_pins twOutStream_Inter/M12_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M13_AXIS [get_bd_intf_ports twOutStream_13] [get_bd_intf_pins twOutStream_Inter/M13_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M14_AXIS [get_bd_intf_ports twOutStream_14] [get_bd_intf_pins twOutStream_Inter/M14_AXIS]
  connect_bd_intf_net -intf_net twOutStream_Inter_M15_AXIS [get_bd_intf_ports twOutStream_15] [get_bd_intf_pins twOutStream_Inter/M15_AXIS]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins Cmd_In_Task_Manager/ap_clk] [get_bd_pins Cmd_Out_Task_Manager/ap_clk] [get_bd_pins New_Task_Manager/ap_clk] [get_bd_pins Remote_Finished_Task_Manager/ap_clk] [get_bd_pins Scheduler_Task_Manager/ap_clk] [get_bd_pins Taskwait_Task_Manager/ap_clk] [get_bd_pins ext_inStream_Inter/ACLK] [get_bd_pins ext_inStream_Inter/M00_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/M01_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/M02_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S00_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S01_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S02_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S03_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S04_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S05_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S06_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S07_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S08_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S09_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S10_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S11_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S12_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S13_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S14_AXIS_ACLK] [get_bd_pins ext_inStream_Inter/S15_AXIS_ACLK] [get_bd_pins inStream_Inter/ACLK] [get_bd_pins inStream_Inter/M00_AXIS_ACLK] [get_bd_pins inStream_Inter/S00_AXIS_ACLK] [get_bd_pins inStream_Inter/S01_AXIS_ACLK] [get_bd_pins inStream_Inter/S02_AXIS_ACLK] [get_bd_pins inStream_Inter/S03_AXIS_ACLK] [get_bd_pins inStream_Inter/S04_AXIS_ACLK] [get_bd_pins inStream_Inter/S05_AXIS_ACLK] [get_bd_pins inStream_Inter/S06_AXIS_ACLK] [get_bd_pins inStream_Inter/S07_AXIS_ACLK] [get_bd_pins inStream_Inter/S08_AXIS_ACLK] [get_bd_pins inStream_Inter/S09_AXIS_ACLK] [get_bd_pins inStream_Inter/S10_AXIS_ACLK] [get_bd_pins inStream_Inter/S11_AXIS_ACLK] [get_bd_pins inStream_Inter/S12_AXIS_ACLK] [get_bd_pins inStream_Inter/S13_AXIS_ACLK] [get_bd_pins inStream_Inter/S14_AXIS_ACLK] [get_bd_pins inStream_Inter/S15_AXIS_ACLK] [get_bd_pins inStream_Taskwait_Inter/ACLK] [get_bd_pins inStream_Taskwait_Inter/M00_AXIS_ACLK] [get_bd_pins inStream_Taskwait_Inter/S00_AXIS_ACLK] [get_bd_pins inStream_Taskwait_Inter/S01_AXIS_ACLK] [get_bd_pins inStream_Taskwait_Inter/S02_AXIS_ACLK] [get_bd_pins outStream_Inter/ACLK] [get_bd_pins outStream_Inter/M00_AXIS_ACLK] [get_bd_pins outStream_Inter/M01_AXIS_ACLK] [get_bd_pins outStream_Inter/M02_AXIS_ACLK] [get_bd_pins outStream_Inter/M03_AXIS_ACLK] [get_bd_pins outStream_Inter/M04_AXIS_ACLK] [get_bd_pins outStream_Inter/M05_AXIS_ACLK] [get_bd_pins outStream_Inter/M06_AXIS_ACLK] [get_bd_pins outStream_Inter/M07_AXIS_ACLK] [get_bd_pins outStream_Inter/M08_AXIS_ACLK] [get_bd_pins outStream_Inter/M09_AXIS_ACLK] [get_bd_pins outStream_Inter/M10_AXIS_ACLK] [get_bd_pins outStream_Inter/M11_AXIS_ACLK] [get_bd_pins outStream_Inter/M12_AXIS_ACLK] [get_bd_pins outStream_Inter/M13_AXIS_ACLK] [get_bd_pins outStream_Inter/M14_AXIS_ACLK] [get_bd_pins outStream_Inter/M15_AXIS_ACLK] [get_bd_pins outStream_Inter/S00_AXIS_ACLK] [get_bd_pins twOutStream_Inter/ACLK] [get_bd_pins twOutStream_Inter/M00_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M01_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M02_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M03_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M04_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M05_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M06_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M07_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M08_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M09_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M10_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M11_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M12_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M13_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M14_AXIS_ACLK] [get_bd_pins twOutStream_Inter/M15_AXIS_ACLK] [get_bd_pins twOutStream_Inter/S00_AXIS_ACLK]
  connect_bd_net -net interconnect_aresetn_1 [get_bd_ports interconnect_aresetn] [get_bd_pins ext_inStream_Inter/ARESETN] [get_bd_pins inStream_Inter/ARESETN] [get_bd_pins inStream_Taskwait_Inter/ARESETN] [get_bd_pins outStream_Inter/ARESETN] [get_bd_pins twOutStream_Inter/ARESETN]
  connect_bd_net -net peripheral_aresetn_1 [get_bd_ports peripheral_aresetn] [get_bd_pins ext_inStream_Inter/M00_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/M01_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/M02_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S00_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S01_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S02_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S03_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S04_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S05_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S06_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S07_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S08_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S09_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S10_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S11_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S12_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S13_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S14_AXIS_ARESETN] [get_bd_pins ext_inStream_Inter/S15_AXIS_ARESETN] [get_bd_pins inStream_Inter/M00_AXIS_ARESETN] [get_bd_pins inStream_Inter/S00_AXIS_ARESETN] [get_bd_pins inStream_Inter/S01_AXIS_ARESETN] [get_bd_pins inStream_Inter/S02_AXIS_ARESETN] [get_bd_pins inStream_Inter/S03_AXIS_ARESETN] [get_bd_pins inStream_Inter/S04_AXIS_ARESETN] [get_bd_pins inStream_Inter/S05_AXIS_ARESETN] [get_bd_pins inStream_Inter/S06_AXIS_ARESETN] [get_bd_pins inStream_Inter/S07_AXIS_ARESETN] [get_bd_pins inStream_Inter/S08_AXIS_ARESETN] [get_bd_pins inStream_Inter/S09_AXIS_ARESETN] [get_bd_pins inStream_Inter/S10_AXIS_ARESETN] [get_bd_pins inStream_Inter/S11_AXIS_ARESETN] [get_bd_pins inStream_Inter/S12_AXIS_ARESETN] [get_bd_pins inStream_Inter/S13_AXIS_ARESETN] [get_bd_pins inStream_Inter/S14_AXIS_ARESETN] [get_bd_pins inStream_Inter/S15_AXIS_ARESETN] [get_bd_pins inStream_Taskwait_Inter/M00_AXIS_ARESETN] [get_bd_pins inStream_Taskwait_Inter/S00_AXIS_ARESETN] [get_bd_pins inStream_Taskwait_Inter/S01_AXIS_ARESETN] [get_bd_pins inStream_Taskwait_Inter/S02_AXIS_ARESETN] [get_bd_pins outStream_Inter/M00_AXIS_ARESETN] [get_bd_pins outStream_Inter/M01_AXIS_ARESETN] [get_bd_pins outStream_Inter/M02_AXIS_ARESETN] [get_bd_pins outStream_Inter/M03_AXIS_ARESETN] [get_bd_pins outStream_Inter/M04_AXIS_ARESETN] [get_bd_pins outStream_Inter/M05_AXIS_ARESETN] [get_bd_pins outStream_Inter/M06_AXIS_ARESETN] [get_bd_pins outStream_Inter/M07_AXIS_ARESETN] [get_bd_pins outStream_Inter/M08_AXIS_ARESETN] [get_bd_pins outStream_Inter/M09_AXIS_ARESETN] [get_bd_pins outStream_Inter/M10_AXIS_ARESETN] [get_bd_pins outStream_Inter/M11_AXIS_ARESETN] [get_bd_pins outStream_Inter/M12_AXIS_ARESETN] [get_bd_pins outStream_Inter/M13_AXIS_ARESETN] [get_bd_pins outStream_Inter/M14_AXIS_ARESETN] [get_bd_pins outStream_Inter/M15_AXIS_ARESETN] [get_bd_pins outStream_Inter/S00_AXIS_ARESETN] [get_bd_pins rst_AND/Op1] [get_bd_pins twOutStream_Inter/M00_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M01_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M02_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M03_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M04_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M05_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M06_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M07_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M08_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M09_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M10_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M11_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M12_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M13_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M14_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/M15_AXIS_ARESETN] [get_bd_pins twOutStream_Inter/S00_AXIS_ARESETN]
  connect_bd_net -net ps_rst_n_1 [get_bd_ports ps_rst_n] [get_bd_pins rst_AND/Op2]
  connect_bd_net -net rst_AND_Res [get_bd_ports managed_aresetn] [get_bd_pins Cmd_In_Task_Manager/ap_rst_n] [get_bd_pins Cmd_Out_Task_Manager/ap_rst_n] [get_bd_pins New_Task_Manager/ap_rst_n] [get_bd_pins Remote_Finished_Task_Manager/ap_rst_n] [get_bd_pins Scheduler_Task_Manager/ap_rst_n] [get_bd_pins Taskwait_Task_Manager/ap_rst_n] [get_bd_pins rst_AND/Res]
