...
################################################################
# This is a generated script based on design: Command_TM
#
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_RESET {interconnect_aresetn:peripheral_aresetn} \
 ] $aclk
...
CONFIG.C_SIZE {1} \
  ...
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins Cmd_In_Task_Manager/outStream] [get_bd_intf_pins outStream_Inter/S00_AXIS]
  connect_bd_intf_net -intf_net S00_AXIS_2 [get_bd_intf_ports inStream_0] [get_bd_intf_pins inStream_Inter/S00_AXIS]
